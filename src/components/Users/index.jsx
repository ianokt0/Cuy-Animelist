...
const Users = async ({ api }) => {
    return (
        <div className="block rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 mt-4">
            <h5 className="mb-4 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50 text-center">{api.message}</h5>
            <hr />
            ...
            <div className="mt-2">
                <span>
                    fetch api
                    <Link href="https://indonesiamitramedia.com" className="ml-1 underline text-color-accent hover:text-color-primary">
                        <i>
                            www.indonesiamitramedia.com
                        </i>
                    </Link>
                </span>
            </div>
